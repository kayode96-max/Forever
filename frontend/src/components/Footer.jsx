...
const Footer = () => {
  return (
    <div>
        <footer className='bg-black flex flex-col p-4 text-sm text-white font-sans'>
            ...
            <p className="text-center text-gray-300 text-xs mt-2">© 2025 Kayode96Max. All rights reserved.</p>
        </footer>
    </div>
  )
}
